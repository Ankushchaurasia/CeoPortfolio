  ...
  return (
    <section id="contact" className="py-10 relative scroll-mt-20">
      ...
      <div className="container mx-auto px-6">
        ...
        <SectionHeader
          title="Let's Connect"
          subtitle="Ready to start a conversation? Reach out and let's explore opportunities."
          badge={<Mail className="text-primary-start" />}
        />
        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            {[
              ...
              { icon: <MapPin size={20} />, title: "Location", val: "Gurgaon, INDIA" },
              { icon: <Calendar size={20} />, title: "Schedule", val: "Book a Meeting" }
            ].map((item, idx) => (

              <div key={idx} className="flex items-center p-6 bg-surface rounded-3xl">
          ...
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            className="flex-1 bg-surface p-8 rounded-[3rem]"
          >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <input
                ...
                required
                className="w-full px-4 py-4 rounded-xl bg-background"
              />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 rounded-xl bg-gradient-to-r-theme flex justify-center items-center gap-2"
              >
