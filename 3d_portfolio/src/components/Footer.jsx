...
import { Mail, Phone, MapPin, Calendar, Linkedin, Twitter ,Instagram} from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-center gap-3"><MapPin size={18} className="text-primary-start"/> Gudgaon, INDIA</li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.instagram.com/countryedu_?igsh=MThxZTJrNGMxMGYwdQ==" className="bg-surface p-3 rounded-full text-gray-400 hover:text-white hover:bg-primary-start transition-all"><Instagram size={18} /></a>
          </div>
        </div>
      </div>
    </footer>
